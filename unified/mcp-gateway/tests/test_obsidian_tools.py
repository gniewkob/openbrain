...
class GatewayObsidianToolTests(unittest.IsolatedAsyncioTestCase):
    async def test_brain_obsidian_vaults_uses_local_adapter(self) -> None:
        ...
        with patch("_gateway_src.main.ObsidianCliAdapter") as adapter_cls:
            adapter = AsyncMock()
    ...
    async def test_brain_obsidian_sync_reads_local_notes_and_writes_v1(self) -> None:
        ...
        with patch("_gateway_src.main.ObsidianCliAdapter") as adapter_cls, patch("_gateway_src.main._client") as mock_client:
            adapter = AsyncMock()
