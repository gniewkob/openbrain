...
class AuthConfig(BaseSettings):
    ...
    policy_registry_json: str = Field(default="", alias="OPENBRAIN_POLICY_REGISTRY_JSON")
    policy_registry_path: str = Field(default="", alias="OPENBRAIN_POLICY_REGISTRY_PATH")
